# !!This is a clone from https://github.com/github/CodeSearchNet/tree/master/function_parser!! Thanks Hamel :)
# Sorry for this gheto version, but I really had no time

## How to run:
- Make sure you have requirement.txt installed from main repo
- Run prepare.sh
- Open the function_parser/create_dataset.ipynb notebook and run it
